//Library Managemant System By Hyder Ali Hashmi
...
void ReqBook(){
	...
	cout<<"Enter book id: ";
	cin>>id;
	issue1.open("C:\\Users\\Desktop\\Book4.csv",ios_base::in);
	if(issue1.is_open()){
		while(getline(issue1,line)){
			...
			if(id==row[0]){
				issue2.open("C:\\Users\\UNAIB COMPUTERS\\Desktop\\RequestBook.csv",ios_base::app);
...
void BookListStud(){
	...
	read.open("C:\\Users\\UNAIB COMPUTERS\\Desktop\\Book4.csv",ios_base::in);
	if(read.is_open()){
...
void AddBook(){
	...
	myFile.open("C:\\Users\\UNAIB COMPUTERS\\Desktop\\Book4.csv", ios_base::app);
...
void IssueBook(){
	...
	issue.open("C:\\Users\\UNAIB COMPUTERS\\Desktop\\RequestBook.csv");
	if(issue.is_open()){
	...
	cin>>id;
	cout<<endl;
	find.open("C:\\Users\\UNAIB COMPUTERS\\Desktop\\Book4.csv",ios_base::in);
	...
	if(issue.is_open()){
		while(getline(issue,line)){
			...
			cout<<id<<endl<<row[0];
			if(id==row[0]){
				File.open("C:\\Users\\UNAIB COMPUTERS\\Desktop\\IssuedBooks.csv",ios_base::app);
...
int main(){
	...
	cout<<"\t\t\t\t    ****************************************"<<endl<<endl;
	cout<<"\t\t\t\t      Made By: Hyder Ali Hashmi\n\n";
	cout<<"\t\t\t\t      Roll number:2307-BSCS009"<<endl<<endl<<endl;
	intro();
